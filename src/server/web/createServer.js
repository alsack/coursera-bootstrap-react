 ...
 */
module.exports = function createServer(port, sslKeys, httpPort=8080) {
  //create http server
  const app = express();
  const server = sslKeys ? createHttpsServer(sslKeys, app, httpPort) : createHttpServer(app);
...
function createHttpsServer(sslKeys, app, httpPort=8080) {
